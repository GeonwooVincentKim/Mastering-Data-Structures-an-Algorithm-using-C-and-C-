...
##
## Debug
ProjectName            :=ArrayPractice
ConfigurationName      :=Debug
WorkspaceConfiguration :=Debug
WorkspacePath          :=E:/Study/C/Mastering-Data-Structures-and-Algorithms-using-C-and-C++/WriteCode
ProjectPath            :=E:/Study/C/Mastering-Data-Structures-and-Algorithms-using-C-and-C++/WriteCode/CodePractice
IntermediateDirectory  :=../build-$(WorkspaceConfiguration)/CodePractice
...
$(IntermediateDirectory)/test.c$(ObjectSuffix): test.c $(IntermediateDirectory)/test.c$(DependSuffix)
	$(CC) $(SourceSwitch) "E:/Study/C/Mastering-Data-Structures-and-Algorithms-using-C-and-C++/WriteCode/CodePractice/test.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/test.c$(ObjectSuffix) $(IncludePath)
